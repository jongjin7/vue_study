  ...
  <div class="row text-center latest-list">
    ...
    <div class="col-md-4 mb-4" v-for="item in getData.community" >
      <div class="card box-shadow">
        <router-link :to="'/community-detail/'+item.id" class="img-thumb"><figure class="card-img-top" :style="'background-image:url('+ item.imagePath + ')'"></figure></router-link>
    ...
    <div class="col-md-4 mb-4" v-for="item in getData.gallery">
      <div class="card box-shadow">
        <router-link :to="'/photo'" class="img-thumb"><figure class="card-img-top" :style="'background-image:url('+ item.imagePath + ')'"></figure></router-link>
        <div class="card-body text-left">
          <p>{{ item.title }}</p>
